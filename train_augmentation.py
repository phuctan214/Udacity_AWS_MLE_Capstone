...
from torchvision.transforms import Compose, Normalize, RandomResizedCrop, ColorJitter, ToTensor, RandomGrayscale, Resize
import torch
...
if __name__ == "__main__":
    ...
    test_dataset = dataset['test'].map(transforms,batched=True)
